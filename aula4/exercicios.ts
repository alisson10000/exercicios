...
if (entradaNota !== null) {
    ...
    if (notaAluno < 0 || notaAluno > 10) {
        ...
        console.log("O aluno está em recuperação")
        const entradaNotaRecuperacao = prompt("informe a nota da recuperação: ")
        if (entradaNotaRecuperacao !== null) {

            const notaRecuperacao = parseFloat(entradaNotaRecuperacao)
            if (notaRecuperacao < 0 || notaRecuperacao > 10) {
                ...
                console.log("O aluno foi aprovado no período da recuperação")
            }
